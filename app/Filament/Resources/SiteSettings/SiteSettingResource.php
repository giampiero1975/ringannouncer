    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Hero')->schema([
                ...
                FileUpload::make('hero_image')->label('Foto hero')->image()->disk('public')->directory('site/hero'),
            ...
            Section::make('Call to action finale')->schema([
                ...
                FileUpload::make('cta_background_image')->label('Sfondo CTA')->image()->disk('public')->directory('site/cta'),
