...
@php
    ...
    $navItems = collect([
        ...
        ['label' => 'Video', 'href' => $pageLinks['video-37'] ?? '#video', 'show' => $videos->isNotEmpty() || isset($pageLinks['video-37'])],
